...
public class BulletPointSnippet {
	...
	public static void main(String[] args) {
		...
		//Clear bullets - lines 2 - 6?
		styledText.setLineBullet(3, 2, null);
		int startOffset = styledText.getOffsetAtLine(2);
		int endOffset = styledText.getOffsetAtLine(6);
		String endLine = styledText.getLine(6);
		endOffset += endLine.length();
		int length = endOffset  - startOffset;
		
		styledText.setStyleRanges(style0.start, style0.length, styledText.getRanges(startOffset,length), null);
